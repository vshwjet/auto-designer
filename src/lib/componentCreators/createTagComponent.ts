export async function createTagComponent(instance: InstanceNode, properties: any) {
    ...
    const mappedProps: { [key: string]: string | boolean } = {
        ...
        "Has Label#10063:91": Boolean(properties.hasLabel !== undefined ? properties.hasLabel : true),
        "Has Leading Icon#10063:273": Boolean(properties.hasLeadingIcon !== undefined ? properties.hasLeadingIcon : true),
        "Has Trailing Icon#10063:364": Boolean(properties.hasTrailingIcon !== undefined ? properties.hasTrailingIcon : true),
