...
"frame": {
  ...
  "cells": [
    ...
    Use this as the componentKeys and details for the Table Columns:
        Column Position=Left, Variant=text: c17ddd7a6ffd0a675618e7c6dd025d5448a70b3e
        Column Position=Intermediate, Variant=text: f039ca49ed47aa7586b25a192852a23665b12f98
        Column Position=Right, Variant=text: 3612063282acd1aa4cf4ba0dcce63f83ea4b4bfc
        Column Position=Left, Variant=checkbox: 3ebf055e1207349d96dec40f1f32a728be2b12b5
        Column Position=Left, Variant=spacer: fd0457a18b275878b7a094d6a5741d76a7508e94
        Column Position=Right, Variant=spacer: 10f6e9268bf87278b6367e21b3b5131148654e21
        Column Position=Intermediate, Variant=spacer: 08bd56d9c07e50df978c7c70280f0d10559e35f8
        Column Position=Left, Variant=amount: 13be1a4b00299a8df2103b9a5960f755e4eb11cf
        Column Position=Right, Variant=amount: 61dad1eebe50beb485b8a2b7a7d3f75b64196523
        Column Position=Intermediate, Variant=amount: 3812866854695461da1f328645adae8f9d6a1ee9
        Column Position=Left, Variant=date: 260a050aa9c87db138a30486a118c311b5df9877
        Column Position=Right, Variant=date: 426cc21788094784597146c19ddab95fcc6dc9df
        Column Position=Intermediate, Variant=date: 946fe74b61f216dc69f127730e4b9882f38c9065
        Column Position=Left, Variant=tag: b78b02c2e6a499627a75ca2a0e9e8419904d7ab0
        Column Position=Right, Variant=tag: 20a4b984845001620e4f5b4cba2f47c62e843ede
        Column Position=Intermediate, Variant=tag: b1a9f958a4558c5ea9bdd8dbe9abcd5f1cf564c8
        Column Position=Left, Variant=icon: 4d56d44d4180eb7e15f0f100e740f09ad27ea35f
        Column Position=Right, Variant=icon: 1c7febfac702919c3dee0284a587f494e056d96b
        Column Position=Intermediate, Variant=icon: 2fef186ac43e0f69e7b6f63986be51356bd9b03f
        Column Position=Left, Variant=user: 179d605c0aa9361e3f73d6ddc0ad7e99af110027
        Column Position=Right, Variant=user: ca66ee1b900f03a617f4a129e5d9cfd32f7e41f5
        Column Position=Intermediate, Variant=user: bdfc894c2f1a1436cfd37508b6cafcf2fb4e0385
